...
carry with them many different credentials, currencies, technologies for each platform. And most of the time, what is used on one platform is unusble or worthless on another. There is no cross-game compatibility (I mean, some games don't even offer cross-platform compatibility),

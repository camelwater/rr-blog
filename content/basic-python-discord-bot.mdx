...
See? You've just created a Discord bot that can use slash commands! If you want to add message-based commands to your bot, replace the `@bot.slash_command` decorator with the `@bot.command` decorator:
